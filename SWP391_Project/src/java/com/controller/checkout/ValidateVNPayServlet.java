...
import com.vnpaypayment.Config;
 ...
 * @author kirit
 */
@WebServlet(name = "ValidateVNPayServlet", urlPatterns = {"/ValidateVNPay"})
public class ValidateVNPayServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String errorMessage = "Checkout error! Error code: " + code;
        ...
        request.setAttribute("vnp_ResponseCode", code);
        ...
        if (code.equals("00")) {
            try {
                ...
                if (orderDAO.insert(order)) {
                    ...
                    out.println("<script>");
                    out.println("alert('Checkout error !');");
