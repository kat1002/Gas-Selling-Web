 ...
 * @author kirit
 */
@WebServlet(name="AddPasswordServlet", urlPatterns={"/addPassword"})
public class AddPasswordServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddPasswordServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddPasswordServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (newpass == null || newpass.trim().isEmpty()) {
            ...
            request.getRequestDispatcher("addPassword.jsp").include(request, response);
            return;
        }
