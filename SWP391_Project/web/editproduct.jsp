...
<html>
    <head>
        ...
        <link rel="icon" href="media/icon/2675933-200.png"/>
        <!-- plugins:css -->
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <a href="manageproduct">
                                                        <span class="closeBtn">
                                                            <img title="Back to product management page" src="media/icon/icons8-product-50.png" width="40" height="40"/>
                                                        </span>
                                                    </a>
                                                    ...
                                                    <form id="productForm" action="editproduct" class="form" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input step="0.01" type="number" id="productPrice" min="0" name="price" value="${product.getPrice()}" class="form-control" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="productDescription">Description</label>
                                                            <textarea id="productDescription" name="description" class="form-control vh-25">${product.getDescription()}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="productPeriod">Warranty Period (months)</label>
                                                            <input name="period" type="number" min="0" id="productPeriod" required class="form-control" value="${product.getWarranty_months()}"/>
                                                        </div>
                                                        <div class="form-group">
