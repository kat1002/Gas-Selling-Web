<%-- 
    ...
    Created on : Jul 10, 2024, 8:42:25 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>BLAZO | EDIT DISCOUNT</title>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form id="editDiscountForm" action="editdiscount" method="post" class="form-sample">
                                                        <input type="hidden" value="${discount.getDiscountId()}" name="id" id="editDiscountId">
                                                        <div class="form-group">
                                                            <label for="editDiscountTitle">Title</label>
                                                            <input type="text" value="${discount.getTitle()}" id="editDiscountTitle" name="title" class="form-control" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editDiscountDescription">Description</label>
                                                            <textarea id="editDiscountDescription" name="description" class="form-control vh-25" style="height: auto; resize: vertical;">${discount.getDescription()}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editDiscountValue">Discount Value</label>
                                                            <input type="number" id="editDiscountValue" value="${discount.getDiscountValue()}" name="discountValue" class="form-control" step="0.01" min="0" max="1" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editExpiryDate">Discount Expiry</label>
                                                            <input type="datetime-local" id="editExpiryDate" value="${discount.getExpiry()}" name="expiry" class="form-control" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editStatus">Status</label>
                                                            <select name="status" class="form-select">
                                                                <option value="1" ${discount.isStatus() eq true ? 'selected':''}>Active</option>
                                                                <option value="2" ${discount.isStatus() eq false ? 'selected':''}>Not active</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="editCategoryDiscount">Category To Discount</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="editProductDiscount">Product To Discount</label>
                                                                    ...
                                                                    <div class="row" id="productRow">
                                                                        <c:forEach items="${requestScope.products}" var="product" varStatus="status">
                                                                            <div class="col-md-4 product-item">
                                                                                <input class="form-check-input" type="checkbox" ${product.getDiscountId() eq discount.getDiscountId() ? 'checked':''} id="productDiscount${product.productId}" name="pid" value="${product.getProductId()}"/>
    ...
    <script>
        ...
        ClassicEditor
                .create(document.querySelector('#editDiscountDescription'), {
