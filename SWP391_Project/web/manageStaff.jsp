...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="media/icon/images.png"/>
                                    ...
                                    <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="row" action="manageStaff">
                                                    <div class="col-md-3">
                                                        <h5>Staff Type</h5>
                                                        <select onchange="this.form.submit()" class="form-select" id="news" name="type">
                                                            ...
                                                            <option value="Sale Staff" <c:if test="${requestScope.type eq 'Sale Staff'}">selected</c:if>>Sale Staff</option>
                                                            <option value="Customer Service Staff" <c:if test="${requestScope.type eq 'Customer Service Staff'}">selected</c:if>>Customer Service Staff</option>
                                                            <option value="Manager" <c:if test="${requestScope.type eq 'Manager'}">selected</c:if>>Manager</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <h5>Clear all</h5>
                                                        <input type="reset" value="Clear All" onclick="location.href = 'manageStaff'"/>
                                                    </div> 
                                                </form>

                                                <hr>
                                                <p class="card-description">
                                                    <a class="btn btn-behance" href="addManager.jsp">
                                                        Add staff</a>
                                                </p>
...
<%             
        List<Manager> listManager = (List<Manager>) request.getAttribute("listManager");
        Gson gson = new GsonBuilder().create();
        String jsonListNews = gson.toJson(listManager);    
%>
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function displayProducts(page) {
            ...
            <td class="productId">` + product.role + `</td>
            <td class="productId">` + product.username + `</td>
            <td class="productId">` + product.email + `</td>
            ...
            <td>
                    ...
                    <a href="editManager?id=` + product.managerId + `">
                        <button class="btn btn-warning">
                            <i class="fa fa-pencil"></i>
                        </button>
                    </a>
                
                    <a href="deleteManager?id=` + product.managerId + `" onclick="return confirmDelete();">
