    ...
    <body>
                                        ...
                                        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form id="voucherForm" action="addVoucher" class="form-sample" method="post">
                                                            ...
                                                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                                                <button class="btn btn-style-1 btn-primary" type="submit">Add Voucher</button>
                                                            </div>
        ...
        <!--        <div class="container mt-7" style="min-height: 500px">
                    ...
                    <div class="col-lg-12 pb-5">
                        <form class="row mt-lg-5" action="addVoucher" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="voucher-code">Voucher Code</label>
                                    <input class="form-control" type="text" id="voucher-code" name="voucherCode" required="">
