    ...
    <body>
        ...
        <main>
                    ...
                    <div class="menu">
                        <a href="add-news-post.jsp" class="news-card" style="text-decoration: none">                            
                            <div style="margin-left: 10px;text-align:center;line-height: 150px; ">
                                <i style="margin-right:10px" class="fa-solid fa-plus"></i>Add Post
                            </div >
                        </a>
                    </div>
                </div>
            ...
            <div class="product-moblie" style=" position: relative;">
                <ul>
                    <c:forEach var="d" items="${sessionScope.listNews}">
                        <li class="product-card-mobile" >
                            <a style="float: left" href="news-post.jsp"><img src="${d.image}" alt="" /></a>
                            <div style="float: left"><h4>${d.title}</h4>
                                <p class="grey none">${d.createdAt}</p>
                                <p class="none" style="margin-top: 10px; color: black;">${d.body}</p>
                            </div>
                        </li>
                    </c:forEach>
                </ul>
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                <a href="news-post?news-id=` + product.newsId + `"><img class="abc" src="` + product.image + `" alt="" /></a>
                <h4>` + product.title + `</h4>
                <p class="grey">` + product.createdAt + `</p>
                <p style="margin-top: 10px; color: black;max-height:147px;overflow:hidden">` + product.body + `</p>
            `;
