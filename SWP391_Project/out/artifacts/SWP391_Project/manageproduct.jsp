...
<html lang="en">
    ...
    <head>
        ...
        <script src="ckeditor5/ckeditor5-build-classic/ckeditor.js"/>
        <script>
...
//                            $('#productEditCategory').val(Product.categoryId);
            ...
            function addQuantity(id, button) {
                $.ajax({
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-description">
                                                        <button id="addProductBtn" class="btn btn-behance"
                                                                onclick="openAddProductForm()">Add product
                                                        </button>
                                                    </p>
                                                            ...
                                                            <c:when test="${requestScope.products.size() > 0}">
                                                                <table class="table table-hover">
                                                                    ...
                                                                    <tbody id="manageproduct">
                                                                        <jsp:useBean id="managername" class="com.model.DAO.ManagerDAO"
                                                                                     scope="request"></jsp:useBean>
                                                                        <jsp:useBean id="discounttitle" class="com.model.DAO.DiscountDAO"
                                                                                     scope="request"></jsp:useBean>
                                                                        <jsp:useBean id="productt" class="com.model.DAO.ProductDAO"
                                                                                     scope="request"></jsp:useBean>
                                                                        <c:forEach items="${requestScope.products}" var="product">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a
                                                                                        href="product?id=${product.getProductId()}"><img
                                                                                            title="${product.getTitle()}"
                                                                                            src="${product.getImages()[0]}"
                                                                                            class="imageproduct"/></a></td>
                                                                                ...
                                                                                <td>
                                                                                    <!--                                                                            <button class="btn btn-facebook"><i class="fa fa-server"></i></button>-->
                                                                                    <button class="btn btn-warning"
                                                                                            onclick="fetchProduct('${product.getTitle()}')">
                    ...
                    <div class="modal-body">
                        <form id="productForm" action="addproduct" class="form-sample" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" id="productName" name="title" class="form-control" required pattern="[A-Za-z0-9\s]{1,}">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-body">
                        <form id="productEditForm" action="editproduct" class="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input step="0.01" type="number" id="productEditPrice" name="price" value="" class="form-control" required>
                            </div>
                            <div class="form-group">
