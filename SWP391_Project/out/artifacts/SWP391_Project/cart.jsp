        ...
        <h1>Shopping Cart</h1>
            <table>
                ...
                <c:forEach items="${cart_items}" var="p">
                    <tr>
                        <td><img src="${productDAO.getProduct(p.getProductId()).getImages()[0]}" alt="Product 1" class="product-img"></td>
                        <td>${productDAO.getProduct(p.getProductId()).getTitle()}</td>
                        <td>$${productDAO.getProduct(p.getProductId()).getPrice()}</td>
                        <td class="quantity">
                        ...
                        <td>$<fmt:formatNumber value="${p.getQuantity() * productDAO.getProduct(p.getProductId()).getPrice()}" type="number" minFractionDigits="2" maxFractionDigits="2"/></td>
