...
<html>
    <head>
        ...
        <script>
            ...
            window.editorDiscount = function (title) {
                window.location = "editdiscount?title=" + title;
            }
            function pageAddDiscount() {
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <form action="managediscount" id="filterSortDiscount" method="get">
                                                                <div class="form-group">
                                                                    <select name="sortchoice" class="form-select" onchange="submitFormAndBuildURL('filterSortDiscount')">
                                                                        <option ${sortchoice eq 'Constant' ? 'selected':''} value="Constant">Constant</option>
                                                        ...
                                                        <div class="col-md-2">
                                                            <h5>Expiry Date</h5>
                                                            <form action="managediscount" method="get" id="filterExpiry">
                                                                <div class="form-group">
                                                                    <input type="date" name="expiryfrom" class="form-control" value="${expiryfrom}"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="date" name="expiryto" class="form-control" value="${expiryto}"/>
                                                                </div>
                                                                <button onclick="submitFormAndBuildURL('filterExpiry')"><i class="fa fa-search"></i></button>
                                                            </form>
                                                        </div>
                                                        <div class="col-md-2">
                                                    ...
                                                    <p class="card-description">
                                                        <button id="addDiscountBtn" class="btn btn-behance"
                                                                onclick="pageAddDiscount()">Add discount
                                                        </button>
                                                    </p>
                                                                    ...
                                                                    <tbody>
                                                                        <c:forEach items="${requestScope.discounts}" var="discount">
                                                                            ...
                                                                            <jsp:useBean id="product" class="com.model.DAO.ProductDAO" scope="request"></jsp:useBean>
                                                                                ...
                                                                                <td>
                                                                                    ${discount.getFormattedExpiry()}
                                                                                </td>
                                                                                <td>
                                                                                    <c:choose>
                                                                                        <c:when test="${discount.isStatus() eq true}"><span class="badge badge-success text-white">Active</span></c:when>
                                                                                        <c:otherwise><span class="badge badge-danger text-white">Not active</span></c:otherwise>
                                                                                    </c:choose>
                                                                                </td>
                                                                                <td>
                                                                                    <button class="btn btn-warning"
                                                                                            onclick="editorDiscount('${discount.getTitle()}')">
