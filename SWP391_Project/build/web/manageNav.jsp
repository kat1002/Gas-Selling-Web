...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="media/icon/clipart365828.png"/>
                                        ...
                                        <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form class="row" id="submitForm" action="manageNav">
                                                        <div class="col-md-3">
                                                            <h5>Category</h5>
                                                            <select onchange="this.form.submit()" class="form-select" id="nav" name="role">
                                                                <option value="all" <c:if test="${requestScope.role eq 'all'}">selected</c:if>>All</option>
                                                                <option value="Header" <c:if test="${requestScope.role eq 'Header'}">selected</c:if>>Header</option>
                                                                <option value="Footer" <c:if test="${requestScope.role eq 'Footer'}">selected</c:if>>Footer</option>
                                                            </select>
                                                        ...
                                                        <div class="col-md-3">
                                                            <h5>Search nav</h5>
                                                            <input onchange="this.form.submit()" type="text" placeholder="Search nav" name="searchName"
                                                                   value="${requestScope.searchName}"/>
                                                        </div>
                                                        
                                                        <div class="col-md-3">
                                                            <h5>Search nav by time create</h5>
                                                        ...
                                                        <div class="col-md-3">
                                                            <h5>Search nav by time modify</h5>
                                                        ...
                                                        <div class="col-md-3">
                                                            <h5>Search nav that created by</h5>
                                                            <input onchange="this.form.submit()" type="number" name="createdBy"
                                                                   ...
                                                                   />
                                                            <h5>Search nav that modified by</h5>
                                                    ...
                                                    <p class="card-description">
                                                        <a class="btn btn-behance" href="addNav.jsp">
                                                            Add Nav</a>
                                                    </p>
    ...
    <%             
            List<Category> listNav = (List<Category>) request.getAttribute("navList");
            Gson gson = new GsonBuilder().create();
            String jsonListNavs = gson.toJson(listNav);    
    %>
    <script>
        var listNews = <%= jsonListNavs %>;
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function displayProducts(page) {
                ...
                for (let i = start; i < end; i++) {
                    ...
                    productRow.id = `productRow-` + product.categoryId;
                    productRow.innerHTML = `
            <td class="productId">` + product.categoryId + `</td>
            <td class="productTitle">` + product.title + `</td>
            <td class="productUrl"><a href="` + product.description + `">`+product.description+`</a></td>
            <td class="productRole">` + product.role + `</td>
            <td class="productCreatedDate">` + product.createdDate + `</td>
            ...
            <td>
                    ...
                    <a href="editNav?id=` + product.categoryId + `">
                        <button class="btn btn-warning">
                            <i class="fa fa-pencil"></i>
                        </button>
                    </a>
                
                    <a href="deleteNav?id=` + product.categoryId + `" onclick="return confirmDelete();">
